# Kombaine — мультиагентная исследовательская платформа для автоматизации исследований
...
Я создал Kombaine, чтобы посмотреть, как автономные агенты могут **декомпозировать сложные
инженерные задачи, координировать работу, проверять результаты и постоянно совершенствоваться
с минимальным вмешательством человека**. Платформа — это эксперимент и рабочий инструмент:
агенты сами придумывают гипотезы, исполняют их, критикуют и принимают только то, что
подтверждено доказательствами, а не «уверенностью модели».
