...
# Top 6 strategies by stability+profitability
strategies = [
    {"ticker": "SBER", "timeframe": "1h", "strategy": "atr_breakout", "params": {"lookback": 10, "atr_mult": 1.0}, "color": "#2196F3"},
    ...
    {"ticker": "LKOH", "timeframe": "1h", "strategy": "vwap_bands", "params": {"lookback": 20, "band_z": 1.5}, "color": "#FF9800"},
    {"ticker": "GAZP", "timeframe": "1h", "strategy": "sma_cross", "params": {"fast": 5, "slow": 20}, "color": "#9C27B0"},
    {"ticker": "Si", "timeframe": "1h", "strategy": "vwap_bands", "params": {"lookback": 30, "band_z": 1.0}, "color": "#F44336"},
    {"ticker": "USDRUB", "timeframe": "1h", "strategy": "atr_breakout", "params": {"lookback": 10, "atr_mult": 1.0}, "color": "#00BCD4"},
]

fig, axes = plt.subplots(3, 2, figsize=(16, 14), sharex=False)
fig.suptitle('TOP-6 Strategies: Equity Stability Check (60d backtest)', fontsize=14, fontweight='bold')
...
for i, s in enumerate(strategies):
    ...
    try:
        ...
        ax.set_title(f"{s['ticker']} {s['timeframe']} {s['strategy']}", fontsize=11, fontweight='bold')
...
plt.tight_layout()
out = '/root/prop-desk/strategy_combine/reports/strategy_architect/top6_equity_stability.png'
